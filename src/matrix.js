...
class Matrix
{
    ...
    static createTranslationMatrix(translation)
    {
        ...
        for (let i = 0; i < translation.length; i++) {
            m.elements[rowIndex + i] = translation[i];
        }
        return m;
    }
    ...
    static createRotationMatrixXYZ(rotation)
    {
        ...
        result = result.multiply(Matrix.createRotationMatrix(rotation[0], 0, 4));
        result = result.multiply(Matrix.createRotationMatrix(rotation[1], 1, 4));
        result = result.multiply(Matrix.createRotationMatrix(rotation[2], 2, 4));
        return result;
    }
